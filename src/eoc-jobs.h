...
#define EOM_TYPE_JOB		       (eoc_job_get_type())
...
#define EOM_TYPE_JOB_THUMBNAIL	       (eoc_job_thumbnail_get_type())
...
#define EOM_TYPE_JOB_LOAD	       (eoc_job_load_get_type())
...
#define EOM_TYPE_JOB_MODEL	       (eoc_job_model_get_type())
...
#define EOM_TYPE_JOB_TRANSFORM	       (eoc_job_transform_get_type())
...
#define EOM_TYPE_JOB_SAVE              (eoc_job_save_get_type())
...
#define EOM_TYPE_JOB_SAVE_AS           (eoc_job_save_as_get_type())
...
#define EOM_TYPE_JOB_COPY	       (eoc_job_copy_get_type())
