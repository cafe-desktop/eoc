...
static void
_eoc_metadata_reader_default_get_raw_exif (EocMetadataReader *emr G_GNUC_UNUSED,
					   guchar           **data,
					   guint             *length)
{
...
static gpointer
_eoc_metadata_reader_default_get_null (EocMetadataReader *emr G_GNUC_UNUSED)
{
	return NULL;
}
static void
